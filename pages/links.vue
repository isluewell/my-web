    ...
    >
      ...
      <div
        ...
        :class="{
          ...
          'bg-gray-900 text-gray-100': mode === 'night'
        }"
      ...
      >
        <div class="p-4 md:p-12 text-center lg:text-left">
          ...
          <div
            class="card-image block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center"
          ></div>
      ...
      <div class="absolute top-0 right-0 h-12 w-18 p-4">
        <button class="js-change-theme focus:outline-none" @click="changeMode">
          {{ mode === 'light' ? '🌙' : '☀️' }}
        </button>
      </div>
    </div>
